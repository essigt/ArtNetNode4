...
void ENC28J60::initSPI () {
    ...
    //bitSet(SPSR, SPI2X); //TODO: Check 2X Mode on XMega 32MHz
}
...
struct __attribute__((__packed__)) transmit_status_vector {
    ...
    uint8_t     transmitCollisionCount      :  4;
    uint8_t     transmitCrcError            :  1;
    uint8_t     transmitLengthCheckError    :  1;
    uint8_t     transmitLengthOutRangeError :  1;
    uint8_t     transmitDone                :  1;
    uint8_t     transmitMulticast           :  1;
    uint8_t     transmitBroadcast           :  1;
    uint8_t     transmitPacketDefer         :  1;
    uint8_t     transmitExcessiveDefer      :  1;
    uint8_t     transmitExcessiveCollision  :  1;
    uint8_t     transmitLateCollision       :  1;
    uint8_t     transmitGiant               :  1;
    uint8_t     transmitUnderrun            :  1;
    uint16_t totalTransmitted; 
    uint8_t     transmitControlFrame        :  1;
    uint8_t     transmitPauseControlFrame   :  1;
    uint8_t     backpressureApplied         :  1;
    uint8_t     transmitVLAN                :  1;
    uint8_t     zero                        :  4;
};
*/
